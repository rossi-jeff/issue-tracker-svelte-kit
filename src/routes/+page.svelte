<svelte:head>
	<title>Issue Tracker by Jeff Rossi</title>
</svelte:head>
...
<div class="mb-4">
	...
	>
	and the CSS framework <a href="https://tailwindcss.com/" target="_blank">Tailwind CSS.</a> The benefit
	of using a component based framework is that it becomes easier to follow the DRY ( don't repeat yourself
	) principle. In addition, effort was made not to reinvent the wheel.
</div>
...
<div class="mb-4">
	...
	The backend api was composed using
	<a href="https://nestjs.com/" target="_blank">Nestjs</a>.
</div>

<div class="mb-4">The source code for all sites is available upon request.</div>
